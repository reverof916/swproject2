...
#define _DUTY_MAX 2038 // 2000
#define _DUTY_NEU 1500 // 1500   원래 1548
#define _DUTY_MIN 1080 // 1000

#define _SERVO_ANGLE_DIFF  104  // Replace with |D - E| degree
#define _SERVO_SPEED       10000  // servo speed
...
float volt_to_distance(int x)
{
  ...
  return 948 + -4.6*x + 7.88E-03*x*x + -4.68E-06*x*x*x;
}
